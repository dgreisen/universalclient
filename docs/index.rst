...
Universal Client is a `Apache 2 <http://www.apache.org/licenses/LICENSE-2.0.html>`_ 
...
requests but even with the `best http library <http://docs.python-requests.org/en/latest/index.html>`_ 
...
`Requests <http://docs.python-requests.org/en/latest/index.html>`_ http library. A Client instance
...
The Client stores a complete api call. It is imutable - any modification returns a new client. This allows
